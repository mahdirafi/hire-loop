  ...
  return (
    <section className="relative w-full overflow-hidden !bg-black">
      ...
      <div className="pointer-events-none absolute inset-0">
        {/* Center top glow - subtle */}
        <div className="absolute left-1/2 top-0 h-[300px] w-[500px] -translate-x-1/2 rounded-full bg-blue-600/10 blur-[100px]" />
        {/* Scattered stars */}
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 py-24 text-center sm:py-32">
        ...
        {/* Search bar */}
        <div className="mt-10 flex w-full max-w-2xl flex-col items-stretch gap-2 rounded-2xl border border-white/10 bg-black/80 p-2 backdrop-blur-sm sm:flex-row sm:items-center">
          <div className="flex flex-1 items-center gap-2 px-3 py-2.5">
            <Magnifier width={18} height={18} className="shrink-0 text-white/40" />
            <input
              type="text"
          ...
          <div className="flex flex-1 items-center gap-2 px-3 py-2.5">
            <MapPin width={18} height={18} className="shrink-0 text-white/40" />
            <input
              type="text"
